...
extension MyServiceIdExt on MyServiceItemId {
  MyServiceItem get item {
    return switch (this) {
      ...
      MyServiceItemId.rideFlow => MyServiceItem(
          title: '騎妙',
          description: '30秒內決定是否騎YouBike，給你最佳騎行決策',
          icon: Assets.svg.iconRideFlow.svg(),
          category: MyServiceCategory.cityLife,
          destinationUrl: 'https://rideflow.motywang.workers.dev/',
        ),
    };
  }
}
